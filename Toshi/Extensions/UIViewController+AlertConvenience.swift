...
extension UIViewController {
    ...
    func showSecurityAlert() {
        let alert = UIAlertController(title: Localized.secure_account_alert_title, message: Localized.secure_account_alert_message, preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: Localized.cancel_action_title, style: .default, handler: { _ in
            alert.dismiss(animated: true, completion: nil)
        }))
        alert.addAction(UIAlertAction(title: Localized.secure_account_alert_action_backup, style: .default, handler: { _ in
